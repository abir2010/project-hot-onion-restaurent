    ...
    <div className="flex justify-center">
      {user.email ? (
        <div className="my-72">
          ...
          <p className="text-5xl">Welcome bro</p>
          <button
            onClick={logOut}
            className="bg-red-500 text-white rounded-md block w-full p-3 text-center rounded-sm dark:text-coolGray-900 dark:bg-violet-400"
          >
            Log out
          </button>
          {console.log(user)}
        ...
        <div className="m-8 w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-coolGray-900 dark:text-coolGray-100">
          ...
          <div className="flex justify-center space-x-4">
            ...
            >
              <svg
                ...
                viewBox="0 0 32 32"
                className="w-7 h-7 fillCurrent bg-white rounded-full p-1"
              >
          ...
          <p className="text-xs text-center sm:px-6 dark:text-coolGray-400">
            ...
            <NavLink to="/signup" className="underline dark:text-coolGray-100">
              Sign up
            </NavLink>
          </p>
        </div>
